...
~file(void) {flush();}	//file will be saved by destructor, there is NO "closing without saving changes"
...
std::cout <<  "You can pull it high by connecting it via a 1k resistor to pin 2. "<< std::endl;
std::cout <<  "You can pull it low by connecting it via a 1k resistor to pin 6. "<< std::endl;
